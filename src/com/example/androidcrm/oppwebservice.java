...
public class oppwebservice {
	...
	public static int invokeLoginWS1(String oppname, int accountid, 
			int stageid, int typeid, int amtD, int LeadSourceID, String token,String cldate,
			String dbname, String webMethName) {
		loginStatus = 1;
		// Create request
